...
class CommitRepository:
    ...
    def update_commit_analysis(self, commit_hash: str, ai_points: int, ai_estimated_hours: float) -> Optional[Commit]:
        """Updates an existing commit with AI analysis results."""
        try:
            logger.info(f"Updating commit analysis: {commit_hash}")
            logger.info(f"New analysis values: Points={ai_points}, Hours={ai_estimated_hours}")
