...
# Replace with a REAL Slack User ID for the manager receiving the reminder
TEST_MANAGER_SLACK_ID = os.getenv("TEST_SLACK_USER_ID", "U0XXXXXXXXX")

# Test payload structure
TEST_PAYLOAD = {
    "manager_slack_id": TEST_MANAGER_SLACK_ID,
    "manager_name": "Test Manager Mastery",
    "mastery_tasks": [
        {
            "id": "mastery-uuid-001",
            "description": "Complete leadership training module 3.",
            "status": "pending",
        ...
        {
            "id": "mastery-uuid-002",
            "description": "Schedule 1:1s with new team members.",
            "status": "pending",
...
# Example payload for a manager with NO pending tasks
TEST_PAYLOAD_NO_TASKS = {
    "manager_slack_id": TEST_MANAGER_SLACK_ID,
    "manager_name": "Test Manager Mastery Empty",
    "mastery_tasks": []
}
# ---
...
if __name__ == "__main__":
    print("--- Testing Make.com Personal Mastery Reminder Webhook --- ")
    send_test_request(TEST_PAYLOAD)

    # Optional: Test the case with no tasks
    # print("\n--- Testing Make.com Personal Mastery Reminder Webhook (No Tasks) --- ")
