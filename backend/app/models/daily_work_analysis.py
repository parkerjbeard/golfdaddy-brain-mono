...
from sqlalchemy import Column, String, Date, JSON, TIMESTAMP, ForeignKey, Float, Integer, Boolean, Text
...
DailyWorkAnalysis.work_items_relation = relationship("WorkItem", back_populates="daily_analysis", cascade="all, delete-orphan")
DailyWorkAnalysis.deduplication_results_relation = relationship("DeduplicationResult", back_populates="daily_analysis", cascade="all, delete-orphan")