...
class TestGitHubIntegration(unittest.TestCase):
    ...
    def test_get_commit_diff(self, mock_get):
        ...
        mock_response.json.return_value = {
            ...
            "commit": {
                ...
                "committer": {"name": "Test User", "email": "test@example.com", "date": "2023-01-01T12:00:00Z"},
    ...
    def test_compare_commits(self, mock_get):
        ...
        result = self.github_integration.compare_commits(
            "test/repo", "6dcb09b5b57875f334f61aebed695e2e4193db5e", "abcd1234abcd1234abcd1234abcd1234abcd1234"
        )
...
async def test_process_commit(mock_get_diff, mock_analyze_commit):
    ...
    mock_analyze_commit.return_value = {"commit_hash": "test123", "ai_estimated_hours": 0.5}
