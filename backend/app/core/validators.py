...
class ReportValidator:
    ...
    WORK_KEYWORDS = [
        "worked", "completed", "finished", "implemented", "fixed", "reviewed",
        "met", "discussed", "analyzed", "created", "updated", "tested",
        "debugged", "deployed", "designed", "wrote", "built", "configured",
        "investigated", "resolved", "attended", "presented", "documented",
        "merged", "submitted", "approved", "planned", "researched", "optimized",
        "refactored", "meeting", "task", "feature", "bug", "issue", "project",
        "code", "review", "pull request", "pr", "commit", "branch", "ticket"
    ]
