    ...
    try:
        ...
        if not weekly_data:
            raise HTTPException(
                ...
                detail="Unable to fetch weekly data from Zapier"
            )
        ...
        raise HTTPException(
            ...
            detail="Internal server error while fetching weekly data"
        )
...
async def get_objectives(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Internal server error while fetching objectives"
        )
...
async def get_company_mission(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Internal server error while fetching mission"
        )
