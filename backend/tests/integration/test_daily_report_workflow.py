...
def sample_commits(sample_user):
    ...
    return [
        Commit(
            ...
            analysis={"complexity": "medium", "impact_areas": ["user-interface", "api"], "quality_score": 0.85},
        ),
        Commit(
            id=uuid4(),
            repository="company/main-app",
            ...
            analysis={"complexity": "low", "impact_areas": ["api", "file-handling"], "quality_score": 0.90},
        ),
    ]
    ...
    async def test_complete_eod_workflow_with_slash_command(self, mock_db_session, sample_user, sample_commits):
        ...
        with (
                ...
                "view": {
                    ...
                    "state": {
                        "values": {
                            ...
                            "hours_worked": {"hours": {"value": "8"}},
                            "blockers": {"blockers": {"value": "Waiting for design approval on profile layout"}},
                        }
                    },
            ...
            mock_ai.analyze_daily_report.return_value = {
                "hours_worked": 8.0,
                "key_achievements": ["Implemented user profile page", "Fixed image upload bug", "Reviewed 3 PRs"],
            ...
            mock_ai.calculate_semantic_similarity = AsyncMock(
                side_effect=[0.95, 0.90]  # High match for profile feature  # High match for upload fix
            )
    ...
    async def test_clarification_flow_integration(self, mock_db_session, sample_user):
        ...
        with (
            ...
            thread_ts = await conversation_handler.start_clarification_conversation(
                user=sample_user, report=vague_report
            )
