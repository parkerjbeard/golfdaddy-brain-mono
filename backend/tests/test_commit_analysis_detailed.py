...
- Reviewed security best practices""",
        ...
        ai_analysis=AiAnalysis(
            ...
            estimated_hours=4.0,
            key_achievements=["OAuth2 provider integration", "JWT token implementation", "Security hardening"],
        ),
    )
...
+        # Test implementation...""",
            ...
            "author": {"name": "John Doe", "email": "john.doe@example.com", "login": "johndoe"},
        }
...
- Follows security best practices""",
        ...
        code_quality = {
            "quality_score": 9.0,
            "issues": [],
            "suggestions": ["Consider implementing refresh token rotation", "Add rate limiting to token endpoints"],
            "security_score": 8.5,
            "test_coverage": "High",
            "code_patterns": {
