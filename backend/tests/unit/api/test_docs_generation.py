...
class TestDocsGenerationAPI:
    ...
    def test_generate_documentation_success_basic(self, client):
        ...
        with (
            patch("app.api.docs_generation.get_supabase_client") as mock_get_supabase,
    ...
    def test_generate_documentation_success_with_git(self, client):
        ...
        mock_git_result = {"status": "success", "url": "https://github.com/owner/docs-repo/blob/main/api/users.md"}
    ...
    def test_generate_documentation_ai_integration_error(self, client):
        ...
        request_data = {"description": "Test documentation", "doc_type": "api"}

        mock_error_doc = {"error": "AI service is currently unavailable"}
    ...
    def test_generate_documentation_empty_description(self, client):
        ...
        request_data = {"description": "", "doc_type": "api"}
    ...
    def test_generate_documentation_custom_format(self, client):
        ...
        request_data = {"description": "HTML documentation", "doc_type": "guide", "format": "html"}
    ...
    def test_generate_documentation_with_file_references(self, client):
        ...
        request_data = {
            ...
            "doc_type": "component",
            "file_references": ["src/components/Button.tsx", "src/components/Button.test.tsx", "src/styles/button.css"],
        }
    ...
    def test_documentation_request_model_validation(self):
        ...
        # Valid request
        valid_data = {"description": "Test documentation", "doc_type": "api", "format": "markdown"}
