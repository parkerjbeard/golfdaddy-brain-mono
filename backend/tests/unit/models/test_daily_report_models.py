...
def test_daily_report_create_creation():
    create_data = {
        "user_id": uuid4(),
        "raw_text_input": "Create text input"
    }
    ...
    with pytest.raises(AttributeError): # Pydantic models don't raise AttributeError for non-existent fields during init, they ignore.
