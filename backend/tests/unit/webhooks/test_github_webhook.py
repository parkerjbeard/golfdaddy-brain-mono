...
class TestGitHubWebhookHandler:
    ...
    async def test_verify_signature_valid(self, handler, webhook_secret):
        ...
        payload = b'{"test": "data"}'
        valid_signature = "sha256=" + hmac.new(webhook_secret.encode(), payload, hashlib.sha256).hexdigest()
    ...
    def test_convert_to_commit_payload(self, handler):
        ...
        payload = handler._convert_to_commit_payload(
            commit, repository="testuser/test-repo", repo_url="https://github.com/testuser/test-repo", branch="main"
        )
    ...
    def test_convert_to_commit_payload_minimal(self, handler):
        ...
        commit = {"id": "xyz789", "message": "", "author": {}}

        payload = handler._convert_to_commit_payload(
            commit, repository="owner/repo", repo_url="https://github.com/owner/repo", branch="develop"
        )
