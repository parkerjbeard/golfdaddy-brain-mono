...
from app.services.doc_quality_service import DocQualityService, QualityLevel, QualityMetrics, ValidationRule
from tests.fixtures.auto_doc_fixtures import MOCK_OPENAI_RESPONSES, QUALITY_TEST_CASES, TEST_CONFIG
...
class TestDocQualityServiceComprehensive:
    ...
    async def test_generate_improvement_suggestions(self, service, mock_openai_client):
        ...
        metrics = QualityMetrics(
            ...
            issues=["Missing examples", "Inconsistent terminology", "No error handling documentation"],
            suggestions=[],
            word_count=200,
        )
